...
Note that our anchor-based RPCA integration represents a faster and more conservative (less correction) method for integration.
...
## Use reference markers  {.tabset .tabset-fade}

```{r annotation_markers,message=FALSE,warning=F, results = 'asis'}
...
```{r eval=FALSE}
de_genes <- FindAllMarkers(dwAnnotated,  min.pct = 0.25, only.pos = TRUE)
